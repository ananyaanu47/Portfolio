...
return (
  <div className ='flex flex-col flex-grow px-6 pt-1'>
    <h5 className= 'my-3 text-base font-medium'> I am currently pursuing B.Tech 3rd year in Electronics and Communication Engineering
    </h5> 
        <div className ='text-lg italic font-extrabold '>
         
        </div>
          <div className ='flex-grow p-4 mt-5 bg-gray-400 dark:bg-dark-100' style= {{marginLeft:'-1.5rem',marginRight:'-1.5rem' }}>
          <h6 className ='my-3 font-semibold tracking-wide text-x1 text'>
       MY Skills
        </h6>
